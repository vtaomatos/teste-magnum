...
export function ConsultaUsuarioDestinatario(documento) {
    ...
    const usuarioValidado = requestApiGet(linkValidarUsuario);
    ...
    const usuarioDestinatario = requestApiGet(linkUsuarioDestinatario);
